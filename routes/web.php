...
Route::middleware(['auth','verified'])->group(function () {
    ...
    Route::get('/admin', [AdminController::class, 'adminView'])->name('adminView');
    Route::get('/admin/banUser', [AdminController::class, 'adminBanUser'])->name('adminBanUser');
    Route::get('/admin/removeProducts', [AdminController::class, 'adminRemoveProductsView'])->name('adminRemoveProductsView');
    Route::delete('/admin/removeProducts/{productId}', [AdminController::class, 'deleteProductsAdmin'])->name('deleteProductsAdmin');
    Route::delete('/admin/banUser/{userId}', [AdminController::class,'deleteUsersAdmin'])->name('deleteUsersAdmin');
